...
$env:STRIPE_PRICE_PRO_MONTHLY_BRL = $env:STRIPE_PRICE_PRO_MONTHLY_BRL -or "price_CHANGE_ME"
$env:STRIPE_PRICE_PRO_ANNUAL_USD = $env:STRIPE_PRICE_PRO_ANNUAL_USD -or "price_CHANGE_ME"
$env:STRIPE_PRICE_PRO_ANNUAL_BRL = $env:STRIPE_PRICE_PRO_ANNUAL_BRL -or "price_CHANGE_ME"
...
$env:PRO_SIGNUP_CODE = $env:PRO_SIGNUP_CODE -or "DEV-PRO-CODE"
...
Write-Host "STRIPE_PRICE_PRO_MONTHLY_BRL: $([string]::IsNullOrWhiteSpace($env:STRIPE_PRICE_PRO_MONTHLY_BRL) -ne $true)"
Write-Host "STRIPE_PRICE_PRO_ANNUAL_USD: $([string]::IsNullOrWhiteSpace($env:STRIPE_PRICE_PRO_ANNUAL_USD) -ne $true)"
Write-Host "STRIPE_PRICE_PRO_ANNUAL_BRL: $([string]::IsNullOrWhiteSpace($env:STRIPE_PRICE_PRO_ANNUAL_BRL) -ne $true)"
...
Write-Host "PRO_SIGNUP_CODE: set"
Write-Host ""
